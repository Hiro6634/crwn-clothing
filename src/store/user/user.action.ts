...
export type EmailSigniInStart = ActionWithPayload<USER_ACTION_TYPES.EMAIL_SIGN_IN_START, 
    {
        email: string; 
        password: string; 
    }
...
export const emailSignInStart = withMatcher((email: string, password: string): EmailSigniInStart => 
